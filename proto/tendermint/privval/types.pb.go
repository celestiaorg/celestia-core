...
type SignedP2PMessageRequest struct {
	Hash     []byte `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`
	ChainId  string `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	UniqueId string `protobuf:"bytes,3,opt,name=unique_id,json=uniqueId,proto3" json:"unique_id,omitempty"`
}

func (m *SignedP2PMessageRequest) Reset()         { *m = SignedP2PMessageRequest{} }
func (m *SignedP2PMessageRequest) String() string { return proto.CompactTextString(m) }
func (*SignedP2PMessageRequest) ProtoMessage()    {}
func (*SignedP2PMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb4e437a5328cf9c, []int{7}
}
func (m *SignedP2PMessageRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignedP2PMessageRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SignedP2PMessageRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SignedP2PMessageRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignedP2PMessageRequest.Merge(m, src)
}
func (m *SignedP2PMessageRequest) XXX_Size() int {
	return m.Size()
}
func (m *SignedP2PMessageRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SignedP2PMessageRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SignedP2PMessageRequest proto.InternalMessageInfo

func (m *SignedP2PMessageRequest) GetHash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func (m *SignedP2PMessageRequest) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
func (m *SignedP2PMessageRequest) GetUniqueId() string {
	if m != nil {
		return m.UniqueId
	}
	return ""
...
func (m *SignedP2PMessageResponse) GetError() *RemoteSignerError {
	if m != nil {
		return m.Error
	}
	return nil
...
type Message struct {
	...
	//	*Message_SignedP2PMessageRequest
	//	*Message_SignedP2PMessageResponse
...
type Message_SignedP2PMessageRequest struct {
	SignedP2PMessageRequest *SignedP2PMessageRequest `protobuf:"bytes,9,opt,name=signed_p2p_message_request,json=signedP2pMessageRequest,proto3,oneof" json:"signed_p2p_message_request,omitempty"`
}
type Message_SignedP2PMessageResponse struct {
	SignedP2PMessageResponse *SignedP2PMessageResponse `protobuf:"bytes,10,opt,name=signed_p2p_message_response,json=signedP2pMessageResponse,proto3,oneof" json:"signed_p2p_message_response,omitempty"`
}
...
func (*Message_SignedP2PMessageRequest) isMessage_Sum()  {}
func (*Message_SignedP2PMessageResponse) isMessage_Sum() {}
...
func (m *Message) GetSignedP2PMessageRequest() *SignedP2PMessageRequest {
	if x, ok := m.GetSum().(*Message_SignedP2PMessageRequest); ok {
		return x.SignedP2PMessageRequest
	}
	return nil
}

func (m *Message) GetSignedP2PMessageResponse() *SignedP2PMessageResponse {
	if x, ok := m.GetSum().(*Message_SignedP2PMessageResponse); ok {
		return x.SignedP2PMessageResponse
	}
	return nil
}
...
func (*Message) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Message_SignedP2PMessageRequest)(nil),
		(*Message_SignedP2PMessageResponse)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*SignedP2PMessageRequest)(nil), "tendermint.privval.SignedP2PMessageRequest")
	proto.RegisterType((*SignedP2PMessageResponse)(nil), "tendermint.privval.SignedP2PMessageResponse")
...
var fileDescriptor_cb4e437a5328cf9c = []byte{
	...
	,
}
...
func (m *SignedP2PMessageRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignedP2PMessageRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignedP2PMessageRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Message_SignedP2PMessageRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignedP2PMessageRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignedP2PMessageRequest != nil {
		{
			size, err := m.SignedP2PMessageRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_SignedP2PMessageResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignedP2PMessageResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignedP2PMessageResponse != nil {
		{
			size, err := m.SignedP2PMessageResponse.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SignedP2PMessageRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message_SignedP2PMessageRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignedP2PMessageRequest != nil {
		l = m.SignedP2PMessageRequest.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Message_SignedP2PMessageResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignedP2PMessageResponse != nil {
		l = m.SignedP2PMessageResponse.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *SignedP2PMessageRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignedP2PMessageRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignedP2PMessageRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignedP2PMessageRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignedP2PMessageRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Message_SignedP2PMessageRequest{v}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignedP2PMessageResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignedP2PMessageResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Message_SignedP2PMessageResponse{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])

...
//
// Chunks are not tied to the peer we asked for them. This is on purpose: a
// bad chunk only makes the restore fail, and the operator can restart state
// sync. See PROTOCO-2759.

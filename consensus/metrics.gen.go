...
func PrometheusMetrics(namespace string, labelsAndValues ...string) *Metrics {
	...
	return &Metrics{
		...
		PrecommitsCounted: prometheus.NewGaugeFrom(stdprometheus.GaugeOpts{
			...
			Help:      "Number of precommit votes counted after the timeout commit period has ended.",
		}, labels).With(labelsAndValues...),
		PrecommitsStakingPercentage: prometheus.NewGaugeFrom(stdprometheus.GaugeOpts{
			Namespace: namespace,
			Subsystem: MetricsSubsystem,
			Name:      "precommits_staking_percentage",
			Help:      "Voting power percentage of precommit votes once the timeout commit period has ended.",
		}, labels).With(labelsAndValues...),

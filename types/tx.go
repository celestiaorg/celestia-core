...
//
// Deprecated: Use github.com/celestiaorg/go-square/v3/tx.UnmarshalBlobTx for new callers;
// check its error before accessing the result, even when the returned bool is true.

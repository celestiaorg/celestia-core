...
type BlockStoreState struct {
	...
	HeaderHeight int64 `protobuf:"varint,3,opt,name=header_height,json=headerHeight,proto3" json:"header_height,omitempty"`
}
...
func (m *BlockStoreState) GetHeaderHeight() int64 {
	if m != nil {
...
var fileDescriptor_ff9e53a0a74267f7 = []byte{
	...
	,
}
...
func (m *BlockStoreState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.HeaderHeight != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.HeaderHeight))
		i--
		dAtA[i] = 0x18
	}
	if m.Height != 0 {
...
func (m *BlockStoreState) Size() (n int) {
	...
	if m.HeaderHeight != 0 {
		n += 1 + sovTypes(uint64(m.HeaderHeight))
	}
	return n
}
...
func (m *BlockStoreState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HeaderHeight", wireType)
			}
			m.HeaderHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HeaderHeight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

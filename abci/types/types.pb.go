...
type Request_PreprocessTxs struct {
	PreprocessTxs *RequestPreprocessTxs `protobuf:"bytes,17,opt,name=preprocess_txs,json=preprocessTxs,proto3,oneof" json:"preprocess_txs,omitempty"`
}
...
type RequestBeginBlock struct {
	...
	MetaData            []byte         `protobuf:"bytes,5,opt,name=meta_data,json=metaData,proto3" json:"meta_data,omitempty"`
}
...
func (m *RequestBeginBlock) GetMetaData() []byte {
	if m != nil {
		return m.MetaData
	}
	return nil
...
type ResponsePreprocessTxs struct {
	Txs      [][]byte `protobuf:"bytes,1,rep,name=txs,proto3" json:"txs,omitempty"`
	MetaData []byte   `protobuf:"bytes,2,opt,name=meta_data,json=metaData,proto3" json:"meta_data,omitempty"`
}
...
func (m *ResponsePreprocessTxs) GetMetaData() []byte {
	if m != nil {
		return m.MetaData
	}
	return nil
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}

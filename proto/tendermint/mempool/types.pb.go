...
type SeenTx struct {
	TxKey [][]byte `protobuf:"bytes,1,rep,name=tx_key,json=txKey,proto3" json:"tx_key,omitempty"`
}
...
var fileDescriptor_2af51926fdbcbc05 = []byte{
	...
	,
	...
	0xa5, 0x95, 0x20, 0x18, 0xe0, 0xa0, 0xd5, 0xc7, 0x0c, 0xf9, 0x24, 0x36, 0xb0, 0x8c, 0x31, 0x20,
	0x00, 0x00, 0xff, 0xff, 0x9e, 0x91, 0xaa, 0xad, 0x96, 0x01, 0x00, 0x00,
}
...
func (m *SeenTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.TxKey) > 0 {
		for iNdEx := len(m.TxKey) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TxKey[iNdEx])
			copy(dAtA[i:], m.TxKey[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.TxKey[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *SeenTx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TxKey = append(m.TxKey, make([]byte, postIndex-iNdEx))
			copy(m.TxKey[len(m.TxKey)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])

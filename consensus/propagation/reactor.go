...
type stateInfoFunc func() *StateInfo
...
// SetStateInfo sets the function returning the state information.
func (blockProp *Reactor) SetStateInfo(stateInfo stateInfoFunc) {
	blockProp.stateInfo = stateInfo
}

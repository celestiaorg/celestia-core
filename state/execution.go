...
func updateState(
	...
	s := State{
		...
		AppHash:                          nil,
		timeoutCommit:                    time.Duration(abciResponses.EndBlock.TimeoutCommit) * time.Second,
		timeoutPropose:                   time.Duration(abciResponses.EndBlock.TimeoutPropose) * time.Second,
	}

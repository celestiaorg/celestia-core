...
// IsRejectedTx returns false and zero as this implementation does not support transaction rejection.
func (*CListMempool) IsRejectedTx(key types.TxKey) (bool, uint32) {
	return false, 0
}

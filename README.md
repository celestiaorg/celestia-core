...
The canonical branches in this repo are based on CometBFT releases. For example: [`v0.38.x-celestia`](https://github.com/celestiaorg/celestia-core/tree/v1.x-celestia) is based on the CometBFT `v0.38.x` release branch and contains Celestia-specific changes.

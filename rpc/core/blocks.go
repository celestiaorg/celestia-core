...
//
// This builds proofs for the whole range and returns only one. Accepted: the
// cost is bounded by the block-range limit and the heavy-request semaphore.
// Reviewed in PROTOCO-2768.

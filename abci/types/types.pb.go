...
func (m *TimeoutInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x42
	n64, err64 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.TimeoutProposeDelta, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.TimeoutProposeDelta):])
	if err64 != nil {
		return 0, err64
	}
	i -= n64
	...
	i--
	dAtA[i] = 0x1a
	n69, err69 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.TimeoutCommit, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.TimeoutCommit):])
	if err69 != nil {
		return 0, err69
	}
	i -= n69

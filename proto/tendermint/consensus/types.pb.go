...
type WantParts struct {
	WantParts *types.WantParts `protobuf:"bytes,1,opt,name=want_parts,json=wantParts,proto3" json:"want_parts,omitempty"`
}
...
func (m *WantParts) GetWantParts() *types.WantParts {
	if m != nil {
		return m.WantParts
	}
	return nil
...
type Message_WantParts struct {
	WantParts *WantParts `protobuf:"bytes,10,opt,name=want_parts,json=wantParts,proto3,oneof" json:"want_parts,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*WantParts)(nil), "tendermint.consensus.WantParts")
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
...
func (m *WantParts) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.WantParts == nil {
				m.WantParts = &types.WantParts{}
			}
			if err := m.WantParts.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

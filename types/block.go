...
type Block struct {
	...
	Header                 `json:"header"`
	Data                   `json:"data"`
	DataAvailabilityHeader ipld.DataAvailabilityHeader `json:"availability_header"`
...
func (b *Block) Hash() tmbytes.HexBytes {
	...
	b.mtx.Lock()
	defer b.mtx.Unlock()
	// short circuit if block is incomplete
	if b.LastCommit == nil || b.DataHash == nil {
		return nil
	}
...
func BlockFromProto(bp *tmproto.Block) (*Block, error) {
	...
	dah, err := ipld.DataAvailabilityHeaderFromProto(bp.DataAvailabilityHeader)
	if err != nil {
		return nil, err
	}
...
func MakeBlock(
	height int64,
	txs []Tx, evidences []Evidence, intermediateStateRoots []tmbytes.HexBytes, messages Messages,
	lastCommit *Commit) *Block {
	evidence := EvidenceData{Evidence: evidences}
	block := &Block{
		Header: Header{
...
func (roots IntermediateStateRoots) splitIntoShares() ipld.NamespacedShares {
...
func (msgs Messages) splitIntoShares() ipld.NamespacedShares {
...
func (data *Data) ComputeShares() (ipld.NamespacedShares, int) {
...
func (data *EvidenceData) splitIntoShares() ipld.NamespacedShares {

...
func CanonicalizeProposal(chainID string, proposal *tmproto.Proposal) tmproto.CanonicalProposal {
	return tmproto.CanonicalProposal{
		...
		AppHash:               proposal.AppHash,
		LastCommitHash:        proposal.LastCommitHash,
		ConsensusHash:         proposal.ConsensusHash,
		NumOriginalDataShares: proposal.NumOriginalDataShares,
	}
}

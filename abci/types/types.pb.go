...
type Request_GetMempoolSequence struct {
	GetMempoolSequence *RequestGetMempoolSequence `protobuf:"bytes,21,opt,name=get_mempool_sequence,json=getMempoolSequence,proto3,oneof" json:"get_mempool_sequence,omitempty"`
}
...
func (*Request_GetMempoolSequence) isRequest_Value()  {}
...
func (m *Request) GetGetMempoolSequence() *RequestGetMempoolSequence {
	if x, ok := m.GetValue().(*Request_GetMempoolSequence); ok {
		return x.GetMempoolSequence
	}
	return nil
}
...
func (*Request) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Request_GetMempoolSequence)(nil),
	}
}
...
type RequestGetMempoolSequence struct {
	Signer []byte `protobuf:"bytes,1,opt,name=signer,proto3" json:"signer,omitempty"`
}

func (m *RequestGetMempoolSequence) Reset()         { *m = RequestGetMempoolSequence{} }
func (m *RequestGetMempoolSequence) String() string { return proto.CompactTextString(m) }
func (*RequestGetMempoolSequence) ProtoMessage()    {}
func (*RequestGetMempoolSequence) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{17}
}
func (m *RequestGetMempoolSequence) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestGetMempoolSequence) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestGetMempoolSequence.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestGetMempoolSequence) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestGetMempoolSequence.Merge(m, src)
}
func (m *RequestGetMempoolSequence) XXX_Size() int {
	return m.Size()
}
func (m *RequestGetMempoolSequence) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestGetMempoolSequence.DiscardUnknown(m)
}

var xxx_messageInfo_RequestGetMempoolSequence proto.InternalMessageInfo

func (m *RequestGetMempoolSequence) GetSigner() []byte {
	if m != nil {
		return m.Signer
	}
	return nil
...
type Response_GetMempoolSequence struct {
	GetMempoolSequence *ResponseGetMempoolSequence `protobuf:"bytes,22,opt,name=get_mempool_sequence,json=getMempoolSequence,proto3,oneof" json:"get_mempool_sequence,omitempty"`
}
...
func (*Response_GetMempoolSequence) isResponse_Value()  {}
...
func (m *Response) GetGetMempoolSequence() *ResponseGetMempoolSequence {
	if x, ok := m.GetValue().(*Response_GetMempoolSequence); ok {
		return x.GetMempoolSequence
	}
	return nil
}
...
func (*Response) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Response_GetMempoolSequence)(nil),
	}
}
...
type ResponseGetMempoolSequence struct {
	Sequence uint64 `protobuf:"varint,1,opt,name=sequence,proto3" json:"sequence,omitempty"`
}

func (m *ResponseGetMempoolSequence) Reset()         { *m = ResponseGetMempoolSequence{} }
func (m *ResponseGetMempoolSequence) String() string { return proto.CompactTextString(m) }
func (*ResponseGetMempoolSequence) ProtoMessage()    {}
func (*ResponseGetMempoolSequence) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{36}
}
func (m *ResponseGetMempoolSequence) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseGetMempoolSequence) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseGetMempoolSequence.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseGetMempoolSequence) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseGetMempoolSequence.Merge(m, src)
}
func (m *ResponseGetMempoolSequence) XXX_Size() int {
	return m.Size()
}
func (m *ResponseGetMempoolSequence) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseGetMempoolSequence.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseGetMempoolSequence proto.InternalMessageInfo

func (m *ResponseGetMempoolSequence) GetSequence() uint64 {
	if m != nil {
		return m.Sequence
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*RequestGetMempoolSequence)(nil), "tendermint.abci.RequestGetMempoolSequence")
	...
	proto.RegisterType((*ResponseGetMempoolSequence)(nil), "tendermint.abci.ResponseGetMempoolSequence")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIClient interface {
	...
	GetMempoolSequence(ctx context.Context, in *RequestGetMempoolSequence, opts ...grpc.CallOption) (*ResponseGetMempoolSequence, error)
}
...
func (c *aBCIClient) GetMempoolSequence(ctx context.Context, in *RequestGetMempoolSequence, opts ...grpc.CallOption) (*ResponseGetMempoolSequence, error) {
	out := new(ResponseGetMempoolSequence)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/GetMempoolSequence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIServer interface {
	...
	GetMempoolSequence(context.Context, *RequestGetMempoolSequence) (*ResponseGetMempoolSequence, error)
}
...
func (*UnimplementedABCIServer) GetMempoolSequence(ctx context.Context, req *RequestGetMempoolSequence) (*ResponseGetMempoolSequence, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMempoolSequence not implemented")
}
...
func _ABCI_GetMempoolSequence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestGetMempoolSequence)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).GetMempoolSequence(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/GetMempoolSequence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).GetMempoolSequence(ctx, req.(*RequestGetMempoolSequence))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMempoolSequence",
			Handler:    _ABCI_GetMempoolSequence_Handler,
		},
	},
...
func (m *Request_GetMempoolSequence) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_GetMempoolSequence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.GetMempoolSequence != nil {
		{
			size, err := m.GetMempoolSequence.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestGetMempoolSequence) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestGetMempoolSequence) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestGetMempoolSequence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_GetMempoolSequence) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_GetMempoolSequence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.GetMempoolSequence != nil {
		{
			size, err := m.GetMempoolSequence.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseGetMempoolSequence) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseGetMempoolSequence) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseGetMempoolSequence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_GetMempoolSequence) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestGetMempoolSequence) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_GetMempoolSequence) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseGetMempoolSequence) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GetMempoolSequence", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestGetMempoolSequence{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_GetMempoolSequence{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RequestGetMempoolSequence) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestGetMempoolSequence: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestGetMempoolSequence: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			...
			v := &ResponseGetMempoolSequence{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_GetMempoolSequence{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ResponseGetMempoolSequence) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseGetMempoolSequence: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseGetMempoolSequence: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {

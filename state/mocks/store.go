...
func (_m *Store) LoadConsensusTimeoutsInfo(i int64) (*abci.TimeoutsInfo, error) {
	//TODO implement me, retrieve the timeouts info from the store
	res := abci.TimeoutsInfo{}
	return &res, nil
}

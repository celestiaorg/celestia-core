...
type Vote struct {
	...
	ValidatorAddress []byte                 `protobuf:"bytes,7,opt,name=validator_address,json=validatorAddress,proto3" json:"validator_address,omitempty"`
	ValidatorIndex   int32                  `protobuf:"varint,8,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty"`
...
func (m *Vote) GetDAHeader() DataAvailabilityHeader {
	if m != nil {
		return m.DAHeader
	}
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}

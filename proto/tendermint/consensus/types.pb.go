...
type PartState struct {
	PartState *types.PartState `protobuf:"bytes,1,opt,name=part_state,json=partState,proto3" json:"part_state,omitempty"`
}
...
func (m *PartState) GetPartState() *types.PartState {
	if m != nil {
		return m.PartState
	}
	return nil
...
type Message_PartState struct {
	PartState *PartState `protobuf:"bytes,10,opt,name=part_state,json=partState,proto3,oneof" json:"part_state,omitempty"`
}
...
func (*Message_PartState) isMessage_Sum()     {}
...
func (m *Message) GetPartState() *PartState {
	if x, ok := m.GetSum().(*Message_PartState); ok {
		return x.PartState
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*PartState)(nil), "tendermint.consensus.PartState")
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
...
func (m *PartState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PartState != nil {
		{
			size, err := m.PartState.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_PartState) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_PartState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.PartState != nil {
		{
			size, err := m.PartState.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Message_PartState) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PartState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PartState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PartState == nil {
				m.PartState = &types.PartState{}
			}
			if err := m.PartState.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

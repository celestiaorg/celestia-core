...
func (m *SharesRange) Reset()         { *m = SharesRange{} }
func (m *SharesRange) String() string { return proto.CompactTextString(m) }
func (*SharesRange) ProtoMessage()    {}
func (*SharesRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3a6e55e2345de56, []int{19}
}
func (m *SharesRange) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SharesRange) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SharesRange.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SharesRange) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SharesRange.Merge(m, src)
}
func (m *SharesRange) XXX_Size() int {
	return m.Size()
}
func (m *SharesRange) XXX_DiscardUnknown() {
	xxx_messageInfo_SharesRange.DiscardUnknown(m)
}

var xxx_messageInfo_SharesRange proto.InternalMessageInfo

func (m *SharesRange) GetStartingShare() uint64 {
	if m != nil {
		return m.StartingShare
	}
	return 0
}

func (m *SharesRange) GetEndShare() uint64 {
	if m != nil {
		return m.EndShare
	}
	return 0
...
func (m *SharesProof) GetRowRoots() [][]byte {
	if m != nil {
		return m.RowRoots
	}
	return nil
...
func (m *SharesProof) GetProofs() []*NMTProof {
	if m != nil {
		return m.Proofs
	}
	return nil
...
func (m *RowsProof) GetRowRoots() [][]byte {
	if m != nil {
		return m.RowRoots
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SharesRange)(nil), "tendermint.types.SharesRange")
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *SharesRange) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SharesRange) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SharesRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.EndShare != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.EndShare))
		i--
		dAtA[i] = 0x10
	}
	if m.StartingShare != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.StartingShare))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *SharesRange) Size() (n int) {
	...
	_ = l
	if m.StartingShare != 0 {
		n += 1 + sovTypes(uint64(m.StartingShare))
	}
	if m.EndShare != 0 {
		n += 1 + sovTypes(uint64(m.EndShare))
	}
	return n
}
...
func (m *SharesRange) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SharesRange: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SharesRange: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StartingShare", wireType)
			}
			m.StartingShare = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StartingShare |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndShare", wireType)
			}
			m.EndShare = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EndShare |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

...
func (_m *Client) BroadcastTxAsync(_a0 context.Context, _a1 []byte) (*coretypes.ResultBroadcastTx, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *coretypes.ResultBroadcastTx
	if rf, ok := ret.Get(0).(func(context.Context, []byte) *coretypes.ResultBroadcastTx); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Client) BroadcastTxCommit(_a0 context.Context, _a1 []byte) (*coretypes.ResultBroadcastTxCommit, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *coretypes.ResultBroadcastTxCommit
	if rf, ok := ret.Get(0).(func(context.Context, []byte) *coretypes.ResultBroadcastTxCommit); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Client) BroadcastTxSync(_a0 context.Context, _a1 []byte) (*coretypes.ResultBroadcastTx, error) {
	ret := _m.Called(_a0, _a1)

...
func TestConsMsgsVectors(t *testing.T) {
	...
	testCases := []struct {
		...
		{"CompactBlockPart", &tmcons.Message{Sum: &tmcons.Message_BlockPart{
			BlockPart: &tmcons.BlockPart{Height: 2, Round: 1, Part: *pbParts, CompactForm: true}}},
			"2a38080210011a3008011204746573741a26080110011a206164645f6d6f72655f6578636c616d6174696f6e5f6d61726b735f636f64652d2001"},

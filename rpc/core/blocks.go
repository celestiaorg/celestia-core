...
//
// This builds a proof for every height in the range but returns only one.
// We accept the extra work because the block range limit and the heavy
// request limit cap it. See PROTOCO-2768.

...
// Wrap implements the p2p Wrapper interface and wraps a tx manifest message.
...
// Wrap implements the p2p Wrapper interface and wraps a want chunk message.
...
// Wrap implements the p2p Wrapper interface and wraps a tx chunk message.

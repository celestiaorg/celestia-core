...
func (mockBlockStore) LoadHeader(height int64) (*types.Header, *types.DataAvailabilityHeader) {
	return nil, nil
}
...
func (mockBlockStore) PruneHeader(height int64) (uint64, error)          { return 0, nil }
func (mockBlockStore) SaveHeader(block *types.Header, daHeader *types.DataAvailabilityHeader, seenCommit *types.Commit) {
}

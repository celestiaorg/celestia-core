...
type Metrics struct {
	...
	//metrics:Number of precommit votes counted after the timeout commit period has ended.
	...
	//metrics:Voting power percentage of precommit votes once the timeout commit period has ended.

...
func TestConsensusConfig_ValidateBasic(t *testing.T) {
	testcases := map[string]struct {
		...
		"TimeoutCommit":                        {func(c *ConsensusConfig) { c.TargetRoundDuration = time.Second }, false},
		"TimeoutCommit negative":               {func(c *ConsensusConfig) { c.TargetRoundDuration = -1 }, true},

...
// OnReset implements service.Service to allow the ticker to be restarted after Stop.
...
// Reset wraps BaseService.Reset().
func (t *timeoutTicker) Reset() error {
	return t.BaseService.Reset()
}

...
type State struct {
	...
	TimeoutPropose time.Duration `protobuf:"bytes,15,opt,name=timeout_propose,json=timeoutPropose,proto3,stdduration" json:"timeout_propose"`
	TimeoutCommit  time.Duration `protobuf:"bytes,16,opt,name=timeout_commit,json=timeoutCommit,proto3,stdduration" json:"timeout_commit"`
}
...
func (m *State) GetTimeoutPropose() time.Duration {
	if m != nil {
...
func (m *State) GetTimeoutCommit() time.Duration {
	if m != nil {
...
var fileDescriptor_ccfacf933f22bf93 = []byte{
	...
	,
}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n9, err9 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.TimeoutCommit, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.TimeoutCommit):])
	if err9 != nil {
		return 0, err9
	}
	i -= n9
	...
	i--
	dAtA[i] = 0x82
	n10, err10 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.TimeoutPropose, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.TimeoutPropose):])
	if err10 != nil {
		return 0, err10
	}
	i -= n10
